...
OPTIONAL_VARS=("NEXT_PUBLIC_PLAY_FANFARE" "NEXT_PUBLIC_PLAY_CLICKS" "NEXT_PUBLIC_ENABLE_CONFETTI" "NEXT_PUBLIC_ENABLE_OPENINGS" "NEXT_PUBLIC_OPENINGS_DEFAULT_VOLUME" "NEXT_PUBLIC_CUSTOM_SITE_URL" "NEXT_PUBLIC_WHEEL_LIMIT")
